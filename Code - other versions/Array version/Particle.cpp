...
void Particle::update_acceleration(int x, int y, int z, Particle* particles[CELL_NUM_X][CELL_NUM_Y][CELL_NUM_Z], int num_particles[CELL_NUM_X][CELL_NUM_Y][CELL_NUM_Z])
{
	...
	for (int ii = 0; ii < 27; ++ii)
	{
		...
		{
			Particle* that = &(particles[i][j][k][l]);
...
void Particle::calc_density_and_pressure(int x, int y, int z, Particle* particles[CELL_NUM_X][CELL_NUM_Y][CELL_NUM_Z], int num_particles[CELL_NUM_X][CELL_NUM_Y][CELL_NUM_Z])
{
	double sum = 0.0;
	for (int ii = 0; ii < 27; ++ii)
	{
